...
object LocalAssistantFallback {
    ...
    private fun extractWeekday(value:String):String? { val n=normalize(value); val m=linkedMapOf("الاثنين" to listOf("الاثنين","اتنين","montag","monday"),"الثلاثاء" to listOf("الثلاثاء","تلاتا","dienstag","tuesday"),"الأربعاء" to listOf("الاربعاء","اربعا","mittwoch","wednesday"),"الخميس" to listOf("الخميس","donnerstag","thursday"),"الجمعة" to listOf("الجمعه","الجمعة","freitag","friday"),"السبت" to listOf("السبت","samstag","saturday"),"الأحد" to listOf("الاحد","sonntag","sunday")); return m.entries.firstOrNull{e->e.value.any{n.contains(normalize(it))}}?.key }
